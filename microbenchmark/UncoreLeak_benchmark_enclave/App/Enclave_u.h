...
#endif
#ifndef OCALL_WAIT_FOR_USER_INPUT_DEFINED__
#define OCALL_WAIT_FOR_USER_INPUT_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_wait_for_user_input, (void));
#endif
#ifndef OCALL_IDLE_SECONDS_DEFINED__
#define OCALL_IDLE_SECONDS_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_idle_seconds, (int seconds));
#endif
#ifndef OCALL_GET_TIME_NS_DEFINED__
#define OCALL_GET_TIME_NS_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_time_ns, (uint64_t* t_ns));
#endif
